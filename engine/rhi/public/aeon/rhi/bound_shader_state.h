...
protected:
    explicit bound_shader_state(aeon::rhi::vertex_shader *vertex_shader, aeon::rhi::pixel_shader *pixel_shader) noexcept
        : resource{}
...
using bound_shader_state_ref = common::intrusive_ptr<bound_shader_state>;
