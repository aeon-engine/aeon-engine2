...
int main([[maybe_unused]] const int argc, [[maybe_unused]] char *argv[])
{
    ...
    aeon::engine::rhi::depth_stencil_state_initializer depth_stencil_state_init;
    depth_stencil_state_init.depth_enable = true;
    depth_stencil_state_init.depth_write_mask = aeon::engine::rhi::depth_write_mask::all;
    depth_stencil_state_init.depth_function = aeon::engine::rhi::comparison_function::less;
    ...
    depth_stencil_state_init.front_face.fail_operation = aeon::engine::rhi::stencil_op::keep;
    depth_stencil_state_init.front_face.depth_fail_operation = aeon::engine::rhi::stencil_op::increase_by_one_wrapped;
    depth_stencil_state_init.front_face.pass_operation = aeon::engine::rhi::stencil_op::keep;
    depth_stencil_state_init.front_face.function = aeon::engine::rhi::comparison_function::always;

    depth_stencil_state_init.back_face.fail_operation = aeon::engine::rhi::stencil_op::keep;
    depth_stencil_state_init.back_face.depth_fail_operation = aeon::engine::rhi::stencil_op::decrease_by_one_wrapped;
    depth_stencil_state_init.back_face.pass_operation = aeon::engine::rhi::stencil_op::keep;
    depth_stencil_state_init.back_face.function = aeon::engine::rhi::comparison_function::always;

    auto depth_stencil_state = rhi_device.create_depth_stencil_state(depth_stencil_state_init);

    aeon::engine::rhi::rasterizer_state_initializer rasterizer_state_init;
    auto rasterizer_state = rhi_device.create_rasterizer_state(rasterizer_state_init);

    aeon::engine::rhi::graphics_pipeline_state_initializer init;
    ...
    init.topology = aeon::engine::rhi::primitive_topology::triangle_list;

    auto graphics_pipeline_state = rhi_device.create_graphics_pipeline_state(init);

    auto vertex_buffer = rhi_device.create_vertex_buffer(aeon::engine::rhi::resource_data{std::data(vertex_buffer_data), vertex_buffer_size});
    auto index_buffer = rhi_device.create_index_buffer(aeon::engine::rhi::resource_data{std::data(index_buffer_data), index_buffer_size});

    matrix_buffer_type matrix_buffer{};
    auto matrix_constant_buffer = rhi_device.create_constant_buffer(aeon::engine::rhi::resource_data{&matrix_buffer, sizeof(matrix_buffer)});
    ...
    auto light_constant_buffer = rhi_device.create_constant_buffer(aeon::engine::rhi::resource_data{&light_buffer, sizeof(light_buffer)});
